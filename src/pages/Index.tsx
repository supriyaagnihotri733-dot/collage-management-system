...
const stats = [
  ...
  { icon: Award, value: "CSJMU", label: "Affiliated to CSJMU University" },
...
const Index = () => {
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-sm font-medium text-yellow-600">Chairman, Bhagwanti Education Centre & Degree College</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <h3 className="section-title text-center mb-10">From the Desk of Secretary</h3>
          <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
            <div className="flex-shrink-0">
              <img
                src={secretaryPhoto}
                alt="Secretary - Bhagwanti Education Centre"
                className="w-48 h-48 md:w-56 md:h-56 rounded-xl object-cover shadow-lg border-4 border-accent/20"
              />
            </div>
            <div className="text-center md:text-left">
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">
                Bhagwanti Education Center Degree College was established in the year 2004. Since then we have improved on many levels. Today, we offer one of the best facilities in various courses. We focus on the overall growth of child students coming from weaker backgrounds who are nurtured and educated to be on contemporary levels. Special classes apart from the curriculum are given to them to make them job-ready.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Our focus is on the whole-time growth of children; hence we have promised one of the best infrastructures with a fully Wi-Fi campus and all sports facilities. Smart classes in rooms to give them more practical knowledge of subjects. We believe in making the future better. A better future a better tomorrow.
              </p>
              <h4 className="text-xl font-heading font-extrabold text-foreground">Mr. Parampreet Singh Saluja</h4>
              <p className="text-sm font-medium text-yellow-600">Secretary, Bhagwanti Education Centre & Degree College</p>
            </div>
          </div>
        </div>
      </section>
